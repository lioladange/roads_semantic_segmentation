...
This project performs U-Net model (from segmentation_models_pytorch) with resnet50 decoder, trained on open source Massachusetts Roads Dataset (https://www.kaggle.com/datasets/balraj98/massachusetts-roads-dataset).
